...
function generateQuestions() {
  ...
  const examDuration = document.getElementById("examDuration").value; // Add this line
...
function saveQuestions() {
  ...
  localStorage.setItem("examDuration", examDuration); // Add this line
...
function startExam() {
  ...
  const storedExamDuration = localStorage.getItem("examDuration"); // Add this line
  if (storedQuestions) {
  ...
  score = 0;
  timeRemaining = parseInt(storedExamDuration) * 60; // Add this line
  showQuestion();
